...
fn add_cell(
    ...
    let plank = world.colliders.insert_with_parent(
    ...
    viewer.set_initial_collider_color(plank, Color::new(0.6, 0.6, 0.6, 1.0));
    world
        .impulse_joints
        .insert(pivot, plank_body, RevoluteJointBuilder::new(), true);
    ...
    for (side, adheres) in [(-1.0, true), (1.0, false)] {
